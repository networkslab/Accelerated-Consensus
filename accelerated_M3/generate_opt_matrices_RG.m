% script for generating the random geometric graph adjacency matrix, and various
...
filename = strcat('matrix_RGG_N', num2str(Nvec));
save(filename, 'Mvec', 'l2_mh_tens', 'l2_opt_tens', ...
               'Wmh_tens', 'Wopt_tens', 'E_tens', 'g_tens', ...
